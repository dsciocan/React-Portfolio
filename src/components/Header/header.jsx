    ...
    <>
        <header className="header">
            ...
            <div className="col-lg-6">
                ...
                <p className="lead">Hi there! I'm Daniela and I always aspire to improve myself as a web developer. This is my portfolio page, where you can find out more about me and my work.</p>
